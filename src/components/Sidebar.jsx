...
export default function Sidebar() {
  return (
    <div className=" min-h-screen w-50 bg-sky-200 min-h-screen flex flex-col p-8">
      ...
      <nav className="flex flex-col space-y-3">
        <Link
          to="/dashboard"
          className="flex items-center space-x-2 p-2 bg-sky-300 rounded"
        >
        ...
        <Link
          to="/exit"
          className="flex items-center space-x-2 p-2 bg-red-500 text-white rounded mt-auto"
        >
